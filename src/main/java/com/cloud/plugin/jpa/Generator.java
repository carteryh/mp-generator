...
//
//		String tag = "lz_precondition_list";
//		// String dbUrl = "jdbc:mysql://db.test.lianzhongjr.net/" + tag +
//		// "?characterEncoding=utf8";
//		String dbUrl = "jdbc:mysql://db.test.lianzhongjr.net/" + tag + "?characterEncoding=utf8";
...
//								.setController("/templete2/controller.java")//
//								.setEntity("/templete2/entity.java")//
//								.setMapper("/templete2/jpa-dao.java")//
//								.setXml("/templete2/mapper.xml")//
//								.setService("/templete2/service.java")//
//								.setServiceImpl("/templete2/serviceImpl.java")//
//								.setDto("/templete2/dto.java")//
//								.setAddDto("/templete2/adddto.java")//
//								.setUpdDto("/templete2/upddto.java")//
//								.setPageinDto("/templete2/pagein.java")//
//								.setPageoutDto("/templete2/pageout.java"));
//		// 执行生成
//		if (1 == result) {
